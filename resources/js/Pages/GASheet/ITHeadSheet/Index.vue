...
const get_json_index = async (page = 1, field = "") => {
    if (field) {
        ...
        filter.direction_it_list =
            filter.direction_it_list == "asc" ? "desc" : "asc";
    }

    //HTTP request
    axios
        .get(
            `it_head/json_index?page=${page}&field=${
                filter.field_it_list
            }&direction=${filter.direction_it_list}&search=${
                filter.search_it_list
            }&search_status=${
            ...
            <CardBox>
                <div class="overflow-x-auto">
                    ...
                    >
                        ...
                        <tbody>
                            <tr v-for="(data, index) in it.data" :key="index">
                                <td
                                    data-label="Status"
                                    class="text-center"
                                >
                                ...
                                >
                                    ...
                                    >
                                        <BaseButton
                                            :route-name="`/ga_sheet/it_head/${data.id}/edit`"
                                            color="info"
                                            :icon="mdiFileEye"
                                            small
                                        />
