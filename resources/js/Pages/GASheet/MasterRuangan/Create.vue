...
const submit = (
  ...
  //send data to server
  router.post(`/ga_sheet/ruangan`, {
      name: form.name,
      value: form.value_gedung.id,
...
const filteredGedung = computed(() => {
  console.log(form.value_location.id)
  ...
  if (form.value_location) {
    ...
    return props.master_gedungs.filter(gedung => gedung.id_lokasi === form.value_location.id);
...
<template>
  <LayoutAuthenticated>
    ...
    <SectionMain>
      ...
      >
        <BaseButton
          :route-name="route('ruangan.index')"
      ...
      <CardBox>
        ...
        <div class="-mx-3 md:flex mb-6">
          <div class="md:w-1/4 px-3 mb-6 md:mb-0">
              <FormField label="Pilih Lokasi" :required="true">
                <label class="typo__label px-20"></label>
                <Multiselect 
                  v-model="form.value_location" 
                  :options="master_lokasis" 
                  placeholder="Pilih Lokasi" 
                  label="name" 
                  @update:modelValue="changeLocation($event)" 
                  track-by="id">
                </Multiselect>
        ...
        <div class="-mx-3 md:flex mb-6">
          <div class="md:w-1/4 px-3 mb-6 md:mb-0">
              <FormField label="Pilih Gedung" :required="true">
                <label class="typo__label px-20"></label>
                <Multiselect 
