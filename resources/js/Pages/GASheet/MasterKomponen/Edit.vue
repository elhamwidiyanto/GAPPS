...
const form = reactive({
  // user_name: props.master_komponen.user_name,
  name: props.master_komponen.name,
  is_active: (props.master_komponen.is_active == 1) ? true : false,
});
...
const submit = (
  ...
  //send data to server
  router.post(`/ga_sheet/komponen/${props.master_komponen.id}`, {
      _method: 'PUT',
      name: form.name,
