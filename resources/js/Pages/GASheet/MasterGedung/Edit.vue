...
const form = reactive({
  // user_name: props.master_gedung.user_name,
  name: props.master_gedung.name,
  is_active: (props.master_gedung.is_active == 1) ? true : false,
});
...
const submit = (
  ...
  //send data to server
  router.post(`/ga_sheet/gedung/${props.master_gedung.id}`, {
      _method: 'PUT',
      name: form.name,
