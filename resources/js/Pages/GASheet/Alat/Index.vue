...
const get_json_index = async (page = 1, field = '') => {
    ...
    if(field){
        filter.field_alat_list = field;
        filter.direction_alat_list = filter.direction_alat_list == 'asc' ? 'desc' : 'asc';
    }

    //HTTP request
    axios.get(`alat/json_index?page=${page}&field=${filter.field_alat_list}&direction=${filter.direction_alat_list}&search=${filter.search_alat_list}&search_status=${(filter.search_status) ? filter.search_status.id : '' }`, {
    })
    .then(response => {

        alat.value = response.data.data;
              ...
              <form @submit.prevent="get_json_index()">
                  <div class="-mx-3 md:flex mb-0 p-3">
                      <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                          <FormControl
                              v-model="filter.search_alat_list"
                              type="text"
                              placeholder="Search..."
                          >
                          </FormControl>
          ...
          <CardBox>
              <div class="overflow-x-auto">
                  ...
                  >
                                  ...
                                  >
                                      ...
                                      <div class="flex flex-col">
                                          <svg
                                              ...
                                              fill="none"
                                              v-if="
                                                  filter.field_alat_list ==
                                                      'user_id' &&
                                                  filter.direction_alat_list ==
                                                      'asc'
                                                      ? true
                                                      : false
                                              "
                      ...
                      <tbody>
                          <tr v-for="(data, index) in alat.data" :key="index">
                              ...
                              >
                                  ...
                                  >
                                      <BaseButton
                                          :route-name="`/ga_sheet/alat/${data.id}/edit`"
                                          color="info"
                  ...
                  <span> Total : {{ alat.total }} </span>
              </div>

              <div class="overflow-x-scroll w-96" v-if="alat.total > 5">
                  <TailwindPagination
                      :data="alat"
                      :number="2"
                      :limit="5"
