...
import { mdiAccountArrowUp, mdiArrowLeftBoldOutline, mdiFileDocumentPlusOutline } from "@mdi/js";
...
const changeAlat = async (value) => {
    try {
        const response = await axios.post(
            `/ga_sheet/it/get_komponen_simbol_kondisi`,
            {
...
const changeAlatQr = async (value) => {
    try {
        const response = await axios.post(
            `/ga_sheet/it/get_komponen_simbol_kondisi_qr`,
            {
                value_alat: value,
            }
        );
...
//   try {
//     const response = await axios.post(`/ga_sheet/it/get_alat_simbol_kondisi`, {
//       value_location: form.value_location,
//       value_gedung: form.value_gedung,
//       value_ruangan: value,
//     })
