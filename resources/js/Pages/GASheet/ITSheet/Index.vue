...
const get_json_index = async (page = 1, field = '') => {
    ...
    if(field){
        filter.field_it_list = field;
        filter.direction_it_list = filter.direction_it_list == 'asc' ? 'desc' : 'asc';
    }

    //HTTP request
    axios.get(`it/json_index?page=${page}&field=${filter.field_it_list}&direction=${filter.direction_it_list}&search=${filter.search_it_list}&search_status=${(filter.search_status) ? filter.search_status.id : '' }`, {
    })
    .then(response => {

        it.value = response.data.data;
        getStatusLabel();
  ...
  <LayoutAuthenticated>
      ...
      <SectionMain>
          <SectionTitleLineWithButton
              ...
              main
          >
          <div class="button-group flex flex-col lg:flex-row lg:justify-end space-y-2 lg:space-y-0 lg:space-x-2">
            <BaseButton
              :route-name="route('it.scan')"
              :icon="mdiQrcode"
              label="Scan"
              color="contrast"
              rounded-full
          ...
          <CardBox class="mb-6" has-table>
            ...
            <cardBox>
                                  ...
                                  >
                                      ...
                                      <div class="flex flex-col">
                                          <svg
                                              ...
                                              fill="none"
                                              v-if="
                                                  filter.field_it_list ==
                                                      'status' &&
                                                  filter.direction_it_list ==
                                                      'asc'
                                                      ? true
                                                      : false
                                              "
                      ...
                      <tbody>
                          ...
                          >
                              ...
                              >
                                  ...
                                  >
                                      <BaseButton
                                          :route-name="`/ga_sheet/it/${data.id}/edit`"
                                          color="info"
                              ...
                              <td class="before:hidden lg:w-1 whitespace-nowrap">
                                <BaseButtons class="w-full justify-end" no-wrap>
                                    <BaseButton
                                    :route-name="`/ga_sheet/it/${data.id}/history`"
                                    color="info"
                                    :icon="mdiHistory"
                                    small
                                    />
              ...
              <div class="overflow-x-scroll w-96" v-if="it.total > 5">
                  <TailwindPagination
                      :data="it"
                      :number="2"
                      :limit="5"
